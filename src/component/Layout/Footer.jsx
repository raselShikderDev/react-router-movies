...
export default function Footer() {
  return (
    ...
    <footer className="bg-gray-800 pt-10 text-white">
      <div className="max-w-screen-lg mx-auto px-4">
        ...
        <div className="text-center pt-5 pb-2">
          <p>&copy;2024  All rights reserved by <a href="https://raseldev.netlify.app/" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline font-semibold">Rasel Shikder</a></p>
        </div>
      </div>
    </footer>
  );
